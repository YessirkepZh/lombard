            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="product-img-wrap">
                        <img src="/images/ring-1.jpeg" alt="Золотые кольца" class="product-main-img" onclick="openModal();">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="product-wrap">
                        ...
                        <div class="product-buy-advantages-wrap">
                            ...
                            <img src="/images/truck2.svg" alt="" class="product-buy-advantage-img">
                            Бесплатная доставка
                            </div>
                        </div>
                        <div class="product-buy-advantages-wrap">
                            <div class="products-buy-advantage">
                            <img src="/images/jewelery.svg" alt="" class="product-buy-advantage-img">
                            Примерка перед покупкой
                            </div>
                        </div>
                        <div class="product-buy-advantages-wrap">
                            <div class="products-buy-advantage">
                            <img src="/images/card-percentage.svg" alt="" class="product-buy-advantage-img">
                            Скидка при онлайн оплате
                            </div>
                        </div>
                        <div class="product-buy-advantages-wrap">
                            <div class="products-buy-advantage">
                            <img src="/images/return.svg" alt="" class="product-buy-advantage-img">
                            Удобный возврат
                            </div>
                        </div>
                        </div>
